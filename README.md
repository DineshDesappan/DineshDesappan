...
#### 🚀 **[Vector-32] Custom STM32 Development Board**

_A production-ready ARM Cortex-M3 development board designed from scratch in KiCad._

- **Core:** STM32F103C8T6 @ 72MHz.
- **Connectivity:** **USB-C** with CC1/CC2 Logic & Impedance-Matched Differential Pairs (D+/D-).
...
- **Advanced Electronics Manufacturing with Power Electronics Fundamentals** – IIT Madras
...
- **LinkedIn:** [linkedin.com/in/dineshd0312](https://www.linkedin.com/in/dineshd0312/)
- **Email:** dineshd0312@gmail.com
- **Location:** India

<!--
**DineshDesappan/DineshDesappan** is a ✨ _special_ ✨ repository that you can use to add `README.md` to your GitHub profile.
-->
